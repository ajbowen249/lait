...
3 Candle
        ...
        <p>
            ...
            The first input given to handlers is <span class="code-span">$</span>, the array of "fields" on the line. Unlike <span class="code-span">awk
            </span>, the array is simply a zero-based array of fields, and there is not a "complete line" entry in <span class="code-span">$</span>. Like
            <span class="code-span">awk</span>, the default field separator is space, and it can be overridden via the <span class="code-span">FS</span>
            global:
        </p><br />
